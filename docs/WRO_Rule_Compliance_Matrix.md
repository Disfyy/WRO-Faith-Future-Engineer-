...
| I-I2C-MAP | Fixed TCA channel mapping must be valid | `docs/WRO_Robot_Assembly_and_Startup_Guide.md` Stage 6.4 | Scanner preflight + TC-01 setup | NEEDS PHYSICAL VERIFY |
