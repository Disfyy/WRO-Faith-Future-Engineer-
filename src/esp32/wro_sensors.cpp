...
bool sens_tf_front_ok()        { return tfFront.ok && tfFront.distMM > 0 && tfFront.distMM < TOF_INVALID_MM; }
...
bool sens_tf_side_ok()         { return tfSide.ok && tfSide.distMM > 0 && tfSide.distMM < TOF_INVALID_MM; }
